		...
		<ul class="nav navbar-nav side-nav">
			...
			<li class="active">
				...
				<ul id="laporan" class="collapse">
					<li class='nav-item'>
						<a class='nav-link' href='lap_stok.php'><i class='fa fa-fw fa-file'></i> Stok Barang</a>
					</li>
					<li class='nav-item'>
						<a class='nav-link' href='lap_beli.php'><i class='fa fa-fw fa-file'></i> Laporan Pembelian</a>
					</li>
					<li class='nav-item'>
						<a class='nav-link' href='lap_jual.php'><i class='fa fa-fw fa-file'></i> Laporan Penjualan</a>
					</li>
				</ul>
			</li>
		</ul>
