...
<html lang="en">
	...
	<body>
		<div id="wrapper">
			...
			<div id="page-wrapper">
				<div class="container-fluid">
					<div class="row">
						<div class="col-lg-12">
							<h2 class="page-header">
								<i class="fa fa-fw fa-file"></i> Laporan Penjualan Barang
							</h2>
						</div>
					</div>
					
					<form action="cetak_lapjual.php" method="POST" enctype="multipart/form-data" class="form-horizontal">
					...
					</form><form action="cetak_lapjual.php" method="POST" enctype="multipart/form-data" class="form-horizontal">
						<div class="form-group row">
		...
		<script language='javascript'>
			...
			function print_d(){
				window.open("cetak_lapjual.php","_blank");
			}
		</script>
